    ...
    Scaffold(
        ...
        ResponsiveContent(modifier = Modifier.padding(padding)) {
            Column(Modifier.fillMaxSize()) {
                ...
                if (isLoading) {
                    // أول تحميل فقط: هيكل مؤقت بنفس تخطيط البطاقات الحقيقية
                    // بدل شاشة فارغة أو مؤشر دوّار مجرّد — يعطي إحساسًا فوريًا
                    // بأن المحتوى قادم وبأي شكل سيبدو.
                    FeedSkeletonList(modifier = Modifier.fillMaxSize())
